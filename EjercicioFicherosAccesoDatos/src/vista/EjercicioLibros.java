...
public class EjercicioLibros {
	...
	//	ProcesamientoFichero proc= new ProcesamientoFichero();
		...
		// guarda la lista de libros obtenida con ProcesamientoFicheroPlano en un fichero binario (librossobj.txt)
		...
		// guarda la lista de libros obtenida con ProcesamientoFicheroPlano en un fichero XML (librosxmldom.txt)
		// y lee el fichero xml (librosxmldom.txt) y devuelve una lista en listadoLibrosXMLDOM
		...
		// guarda la lista de libros obtenida con ProcesamientoFicheroPlano en un fichero XML (librosxmljaxb.txt)
		// y lee el fichero xml (librosxmljaxb.txt) y devuelve una lista en listadoLibrosXMLJAXB
		...
		// guarda la lista de libros obtenida con ProcesamientoFicheroPlano en un fichero (librosjsongson.txt)
		// y lee el fichero (librosjsongson.txt) y devuelve una lista en listadoLibrosJSONGSON
		...
		// lee el fichero xml (librosxmldom.txt) y devuelve una lista en listadoLibrosSAX 
